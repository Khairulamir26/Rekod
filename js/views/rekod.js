...
CT.views.rekod = (function () {
  ...
  function kadRekod(murid) {
    ...
    kad.innerHTML =
      ...
      /* Juz sentiasa dipaparkan sebagai "Juz N" sahaja. Apabila belum
         direkod, nilainya diambil daripada muka surat sambungan. */
      '<div><b>Juz</b>' +
      (r.juz ? 'Juz ' + r.juz
        : sambungKad && sambungKad.juz ? 'Juz ' + sambungKad.juz
