...
CT.views.murid = (function () {
  ...
  /* Semester menaik: Sem 1 di atas, Sem 8 di bawah. Nama menjadi pemutus
     dalam semester yang sama. Murid tanpa semester diletakkan di atas sekali
     supaya profil yang belum lengkap itu dilihat dan dibetulkan, bukan
     tersembunyi di hujung senarai. */
  function susunSemester(a, b) {
    var sa = +a.semester || 0;
    var sb = +b.semester || 0;
