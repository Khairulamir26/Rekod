...
CT.views.kalendar = (function () {
  ...
  /* ---------- Bar penyegerakan ----------
     Bar ini hanya muncul apabila tahun yang dilihat betul-betul tiada cuti
     diketahui — iaitu di luar julat senarai terbina dan belum pernah
     disegerakkan. Selagi cuti terpapar dengan betul, dari mana sumbernya
     bukan urusan guru, jadi tiada apa yang perlu ditunjukkan. */
  function barSegerak() {
    var status = CT.cuti.statusSegerak(lihat.tahun);
    if (status.bilangan > 0) { return null; }
    ...
    kad.innerHTML =
      ...
      '<span class="kecil tumbuh" data-status>Tiada cuti umum diketahui untuk ' +
      lihat.tahun + '. Segerakkan untuk memuat turunnya.</span>' +
